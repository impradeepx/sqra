...
<body>
    ...
    <div class="top-content">
        <h1 style="font-size:35px;">Welcome to SQRA, Share your moments with friends!</h1>
    ...
    <footer>			
    	<div class="footer"> 
    		...
    		<p> ©2020 All Rights Reserved <BR> Website designed and developed by <strong><U>PRADEEP</u></strong></p>
    	</div>
    </footer>
