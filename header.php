...
<a href="index.php" style="text-decoration: none; color: #44c2d8;"><img src="images/favigon.jpg" alt="O" style="height: 2%; width: 2%; margin: 18px 3px -10px 30px;">
    <span style="font-family: Roboto;/*! text-decoration: none; */font-size: 26px;">OCEAN</span></a>
