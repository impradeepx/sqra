...
<div class="top-content">
        <h1 style="font-size:20px;">Welcome to SQRA, Share your moments with friends!</h1>
...
<div class="signin-form">
            ...
            <div class="form-bottom">
                ...
                <form action="login.php" method="POST" class="login-form">
                   ...
                   <button style = background-color:green;> <a style =text-decoration:none;color:white; href="register.php">Register</a></button>
                </form> 
    ...
    <footer>			
    	<div class="footer"> 
    		...
    		<p> &copy;<?php echo  date("Y"); ?> All Rights Reserved <BR> Website designed and developed by <strong><U>PRADEEP</u></strong></p>
    	</div>
    </footer>
</body>
</html>